...
- Name: disconnected-state.spec.ts >> Disconnected State — Sync Config Page (Access Restricted) >> LP-DIS-078 | Sync Config restricted page still shows WordPress admin chrome
- Location: tests/disconnected-state.spec.ts:483:7
