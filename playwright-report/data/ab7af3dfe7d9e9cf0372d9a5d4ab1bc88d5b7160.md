...
- Name: disconnected-state.spec.ts >> Disconnected State — Mappings Page >> LP-DIS-061 | Mappings tab bar shows all 4 tabs
- Location: tests/disconnected-state.spec.ts:372:7
...
Expected: visible
Error: strict mode violation: getByText('Products') resolved to 8 elements:
