...
- Name: disconnected-state.spec.ts >> Disconnected State — Connect CTA Navigation >> LP-DIS-095 | Connection page "Connect your store" CTA is clickable and navigates
- Location: tests/disconnected-state.spec.ts:590:7
...
Call log:
  - waiting for getByRole('button', { name: /connect your store/i })
    ...
    - main [ref=e317]:
      - generic [ref=e320]:
        - generic [ref=e321]:
          ...
          - generic [ref=e335]:
            - generic [ref=e337]:
              - heading "Connections" [level=1] [ref=e338]
              - paragraph [ref=e339]: Manage how LedgerPort connects to your store and accounting platform.
            - generic [ref=e343]:
              - generic [ref=e344]:
  ...
  - contentinfo [ref=e370]:
    - paragraph [ref=e371]:
      - generic [ref=e373]:
        ...
        - text: .
    - paragraph [ref=e375]: Version 6.9.4
```
