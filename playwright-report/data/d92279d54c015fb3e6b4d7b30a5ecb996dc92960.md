...
- Name: disconnected-state.spec.ts >> Disconnected State — Dashboard >> LP-DIS-043 | Connections widget does NOT show "Connected" for either service
- Location: tests/disconnected-state.spec.ts:269:7
