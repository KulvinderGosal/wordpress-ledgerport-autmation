...
- Location: tests/mappings.spec.ts:252:7
...
Locator: getByText('cod')
Expected: visible
Error: strict mode violation: getByText('cod') resolved to 12 elements:
    1) <div class="wp-menu-name">Shortcoder</div> aka getByRole('link', { name: 'Shortcoder' })
    2) <li aria-hidden="true" class="wp-submenu-head">Shortcoder</li> aka locator('li').filter({ hasText: /^Shortcoder$/ })
    3) <a class="wp-first-item" href="edit.php?post_type=shortcoder">All Shortcodes</a> aka getByRole('link', { name: 'All Shortcodes' })
    4) <a href="post-new.php?post_type=shortcoder">Create shortcode</a> aka getByRole('link', { name: 'Create shortcode' })
    5) <div class="wp-menu-name">Code Snippets</div> aka getByRole('link', { name: 'Code Snippets' }).first()
    6) <li aria-hidden="true" class="wp-submenu-head">Code Snippets</li> aka getByText('Code Snippets').nth(1)
    7) <a class="wp-first-item" href="admin.php?page=wpcode">Code Snippets</a> aka getByRole('link', { name: 'Code Snippets' }).nth(1)
    8) <a class="ab-item" role="menuitem" href="https://qastaging.pushengage.com/wp-admin/post-new.php?post_type=shortcoder">Shortcode</a> aka getByText('Shortcode', { exact: true })
    9) <a class="ab-item" role="menuitem" aria-expanded="false" href="https://qastaging.pushengage.com/wp-admin/admin.php?page=wpcode">WPCode</a> aka getByRole('menuitem', { name: 'WPCode' })
    10) <a class="ab-item" role="menuitem" aria-expanded="false" href="https://qastaging.pushengage.com/wp-admin/admin.php?page=wpcode">…</a> aka getByText('Code Snippets (1)')
    ...

Call log:
  - Expect "toBeVisible" with timeout 15000ms
  - waiting for getByText('cod')
          ...
          - generic [ref=e362]:
            ...
            - generic [ref=e370]:
              ...
              - button "Help" [ref=e373] [cursor=pointer]:
                - img
          - generic [ref=e376]:
            - heading "Mappings" [level=1] [ref=e377]
            - paragraph [ref=e378]: Map WooCommerce products, variations, customers, and payment methods to QuickBooks Online.
          - navigation [ref=e381]:
            - generic [ref=e382]:
              - tab "Products" [ref=e383] [cursor=pointer]
              - tab "Variations" [ref=e384] [cursor=pointer]
              - tab "Customers" [ref=e385] [cursor=pointer]
              - tab "Payment Methods" [active] [selected] [ref=e386] [cursor=pointer]
          - generic [ref=e388]:
            - generic [ref=e389]:
              - heading "Map WooCommerce Payment Gateways to QuickBooks" [level=3] [ref=e390]
              - paragraph [ref=e391]: Map each WooCommerce payment gateway to the corresponding QuickBooks Online payment method.
            - table [ref=e394]:
              - rowgroup [ref=e395]:
                - row "ID WooCommerce Payment Gateway QuickBooks Payment Method Status" [ref=e396]:
                  - columnheader "ID" [ref=e397]
                  - columnheader "WooCommerce Payment Gateway" [ref=e398]
                  - columnheader "QuickBooks Payment Method" [ref=e399]
                  - columnheader "Status" [ref=e400]
              - rowgroup [ref=e401]:
                - row "bacs Direct bank transfer — Not mapped — Unmapped" [ref=e402]:
                  - cell "bacs" [ref=e403]
                  - cell "Direct bank transfer" [ref=e404]:
                    - generic [ref=e405]: Direct bank transfer
                  - cell "— Not mapped —" [ref=e406]:
                    - generic [ref=e409] [cursor=pointer]:
                      - textbox "Select mapping…" [ref=e410]: — Not mapped —
                      - img [ref=e411]
                  - cell "Unmapped" [ref=e413]:
                    - generic [ref=e414]: Unmapped
                - row "cheque Check payments — Not mapped — Unmapped" [ref=e415]:
                  - cell "cheque" [ref=e416]
                  - cell "Check payments" [ref=e417]:
                    - generic [ref=e418]: Check payments
                  - cell "— Not mapped —" [ref=e419]:
                    - generic [ref=e422] [cursor=pointer]:
                      - textbox "Select mapping…" [ref=e423]: — Not mapped —
                      - img [ref=e424]
                  - cell "Unmapped" [ref=e426]:
                    - generic [ref=e427]: Unmapped
                - row "cod Cash on delivery — Not mapped — Unmapped" [ref=e428]:
                  - cell "cod" [ref=e429]
                  - cell "Cash on delivery" [ref=e430]:
                    - generic [ref=e431]: Cash on delivery
                  - cell "— Not mapped —" [ref=e432]:
                    - generic [ref=e435] [cursor=pointer]:
                      - textbox "Select mapping…" [ref=e436]: — Not mapped —
                      - img [ref=e437]
                  - cell "Unmapped" [ref=e439]:
                    - generic [ref=e440]: Unmapped
        - region "Notifications alt+T"
  - contentinfo [ref=e441]:
    - paragraph [ref=e442]:
      - generic [ref=e444]:
        - text: Thank you for creating with
        - link "WordPress" [ref=e445] [cursor=pointer]:
          - /url: https://wordpress.org/
        - text: .
    - paragraph [ref=e446]: Version 6.9.4
```
