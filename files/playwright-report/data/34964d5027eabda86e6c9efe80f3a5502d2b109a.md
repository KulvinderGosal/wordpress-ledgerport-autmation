...
- Name: responsive.spec.ts >> LedgerPort — Responsive & UI >> interactive buttons have accessible text
- Location: tests/responsive.spec.ts:149:7
                      ...
                      - generic [ref=e475]:
                        - generic [ref=e476]:
                          ...
                          - generic [ref=e478]:
                            ...
                            - generic [ref=e481]: about 14 hours ago
                      ...
                      - generic [ref=e483]:
                        - generic [ref=e484]:
                          ...
                          - generic [ref=e486]:
                            ...
                            - generic [ref=e489]: about 15 hours ago
...
> 158 |       expect(text || ariaLabel || title).toBeTruthy();
  ...
  176 |   // ── Page titles ──────────────────────────────────────────────────────────────
  177 | 
  178 |   test('Dashboard page has a descriptive browser title', async ({ page }) => {
  179 |     await goToPluginPage(page, PLUGIN_PAGES.dashboard);
  180 |     const title = await page.title();
  181 |     expect(title.length).toBeGreaterThan(5);
  182 |   });
  183 | 
  184 |   test('Connection page has a descriptive browser title', async ({ page }) => {
  185 |     await goToPluginPage(page, PLUGIN_PAGES.connection);
  186 |     const title = await page.title();
  187 |     expect(title.length).toBeGreaterThan(5);
  188 |   });
  189 | 
  190 |   test('Debug Logs page has a descriptive browser title', async ({ page }) => {
  191 |     await goToPluginPage(page, PLUGIN_PAGES.debugLogs);
  192 |     const title = await page.title();
  193 |     expect(title.length).toBeGreaterThan(5);
  194 |   });
  195 | });
  196 | 
```