...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> sidebar highlights "Dashboard" link when on that page
- Location: tests/navigation.spec.ts:49:9
...
Locator: locator('#adminmenu').getByRole('link', { name: 'Dashboard' }).locator('..')
Expected pattern: /current|active/
Error: strict mode violation: locator('#adminmenu').getByRole('link', { name: 'Dashboard' }).locator('..') resolved to 3 elements:
    1) <li id="menu-dashboard" class="wp-first-item wp-has-submenu wp-not-current-submenu menu-top menu-top-first menu-icon-dashboard menu-top-first">…</li> aka getByText('Dashboard DashboardHomeUpdates')
    2) <li class="wp-first-item current">…</li> aka locator('#toplevel_page_ledgerport').getByRole('listitem').filter({ hasText: 'Dashboard' })
    3) <li class="wp-first-item">…</li> aka locator('#toplevel_page_pushengage').getByRole('listitem').filter({ hasText: 'Dashboard' })

Call log:
  - Expect "toHaveClass" with timeout 15000ms
  - waiting for locator('#adminmenu').getByRole('link', { name: 'Dashboard' }).locator('..')
            ...
            - generic [ref=e381]:
              ...
              - generic [ref=e384]:
                - combobox [ref=e385] [cursor=pointer]:
                  ...
                  - img [ref=e387]
                - button "May 10, 2026 – May 16, 2026" [ref=e389] [cursor=pointer]:
                  - img
                  - generic [ref=e390]: May 10, 2026 – May 16, 2026
            - generic [ref=e391]:
...
```ts
  ...
  39  |       await page.locator('#adminmenu').getByRole('link', { name: label }).click();
  40  |       await page.waitForLoadState('domcontentloaded');
  41  |       await page.waitForTimeout(1500);
  42  |       await expect(page).toHaveURL(pg.urlMatch);
  43  |     });
  44  |   }
  45  | 
