...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> unauthenticated dashboard access redirects to login
- Location: tests/navigation.spec.ts:132:7
...
Received string:  "https://qastaging.pushengage.com/wp-admin/admin.php?page=ledgerport"
Timeout: 15000ms

Call log:
  - Expect "toHaveURL" with timeout 15000ms
    33 × unexpected value "https://qastaging.pushengage.com/wp-admin/admin.php?page=ledgerport"
...
- main:
  ...
  - button "May 10, 2026 – May 16, 2026"
  - text: "Last sync: about 3 hours ago"
  - button "Sync now"
  - paragraph: Sync health
  - paragraph: 92% success rate
  - paragraph: 104 total syncs
  - button "View error log"
  - paragraph: Orders
  - paragraph: 6 orders
  - paragraph: 100.0% success rate
  - button "View report"
  - paragraph: Needs attention
  - paragraph: 1 items
  - paragraph: Issues need your review
  ...
  - paragraph: Synced 16 orders to QuickBooks
  - text: queue_run order about 3 hours ago success
  - paragraph: Synced 18 orders to QuickBooks
  - text: queue_run order about 14 hours ago success
  - paragraph: Synced 39 orders to QuickBooks
  - text: queue_run order about 15 hours ago success
  - paragraph: Synced 40 orders to QuickBooks
  - text: queue_run order about 16 hours ago success
  - paragraph: Synced 41 orders to QuickBooks
  - text: queue_run order about 17 hours ago success
  - heading "Setup checklist" [level=3]
  - text: Connect WooCommerce Connect QuickBooks Configure sync settings Enable automatic sync
