...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> sidebar highlights "Mappings" link when on that page
...
Locator: locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Mappings' }).locator('..')
...
Call log:
  ...
  - waiting for locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Mappings' }).locator('..')
