...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> sidebar link "Audit Logs" navigates correctly
...
Call log:
  - waiting for locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Audit Logs' })
