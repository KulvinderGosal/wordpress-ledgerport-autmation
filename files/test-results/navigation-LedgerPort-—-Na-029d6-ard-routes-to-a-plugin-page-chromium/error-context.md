...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> "Review issues" on dashboard routes to a plugin page
- Location: tests/navigation.spec.ts:100:7
...
Call log:
  - waiting for getByRole('button', { name: /Review issues/i })
