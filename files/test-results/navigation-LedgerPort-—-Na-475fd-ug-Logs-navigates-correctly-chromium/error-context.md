...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> sidebar link "Debug Logs" navigates correctly
...
Call log:
  - waiting for locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Debug Logs' })
