...
- Name: manual-sync.spec.ts >> LedgerPort — Manual Sync (Send to QuickBooks) >> Manual Sync menu item is highlighted in sidebar
- Location: tests/manual-sync.spec.ts:153:7
