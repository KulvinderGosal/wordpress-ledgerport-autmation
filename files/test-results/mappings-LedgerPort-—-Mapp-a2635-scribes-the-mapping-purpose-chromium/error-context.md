...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> page subtitle describes the mapping purpose
- Location: tests/mappings.spec.ts:20:7
...
Locator: getByText(/Map WooCommerce products, variations, customers, and payment methods/i)
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText(/Map WooCommerce products, variations, customers, and payment methods/i)
