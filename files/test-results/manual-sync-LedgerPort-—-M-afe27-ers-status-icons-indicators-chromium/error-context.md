...
- Name: manual-sync.spec.ts >> LedgerPort — Manual Sync (Send to QuickBooks) >> Sync column renders status icons/indicators
- Location: tests/manual-sync.spec.ts:146:7
