...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> sidebar link "Sync Config" navigates correctly
...
Call log:
  - waiting for locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Sync Config' })
