...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> pagination shows total product count
- Location: tests/mappings.spec.ts:101:7
...
Locator: locator('text=/Showing \\d+.\\d+ of \\d+/i').first()
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('text=/Showing \\d+.\\d+ of \\d+/i').first()
