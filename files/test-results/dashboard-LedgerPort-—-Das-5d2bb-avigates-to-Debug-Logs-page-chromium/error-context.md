...
- Name: dashboard.spec.ts >> LedgerPort — Dashboard >> sidebar Debug Logs link navigates to Debug Logs page
- Location: tests/dashboard.spec.ts:329:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_CLOSED at https://qastaging.pushengage.com/wp-admin/
Call log:
