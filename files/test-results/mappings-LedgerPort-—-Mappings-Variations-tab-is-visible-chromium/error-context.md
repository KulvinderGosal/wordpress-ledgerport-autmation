...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Variations tab is visible
- Location: tests/mappings.spec.ts:30:7
...
Locator: getByRole('tab', { name: /Variations/i }).or(getByRole('button', { name: /Variations/i }))
Expected: visible
Timeout: 30000ms
