...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> page heading is "Mappings"
- Location: tests/mappings.spec.ts:16:7
...
Locator: getByRole('heading', { name: /^Mappings$/i }).first()
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /^Mappings$/i }).first()
