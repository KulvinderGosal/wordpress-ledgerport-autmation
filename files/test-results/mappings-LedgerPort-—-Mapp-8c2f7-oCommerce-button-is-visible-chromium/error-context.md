...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Refresh WooCommerce button is visible
- Location: tests/mappings.spec.ts:93:7
...
Locator: getByRole('button', { name: /Refresh WooCommerce/i }).or(getByText(/refresh WooCommerce/i))
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Refresh WooCommerce/i }).or(getByText(/refresh WooCommerce/i))
