...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> browser forward button restores page after going back
...
Call log:
  - waiting for locator('#adminmenu').getByRole('link', { name: 'Connection' })
