...
- Name: responsive.spec.ts >> LedgerPort — Responsive & UI >> Mappings table container allows horizontal scroll on 768px
- Location: tests/responsive.spec.ts:61:7
...
Locator: locator('table, [class*="table-container"]').first()
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('table, [class*="table-container"]').first()
