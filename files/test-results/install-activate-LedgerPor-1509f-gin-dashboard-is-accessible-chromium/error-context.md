...
- Name: install-activate.spec.ts >> LedgerPort Plugin — Install / Activate / Deactivate >> reactivated plugin dashboard is accessible
- Location: tests/install-activate.spec.ts:137:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://qastaging.pushengage.com/wp-admin/
Call log:
