...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Payment Methods tab is visible
- Location: tests/mappings.spec.ts:38:7
...
Locator: getByRole('tab', { name: /Payment Methods/i }).or(getByRole('button', { name: /Payment Methods/i }))
Expected: visible
Timeout: 30000ms
