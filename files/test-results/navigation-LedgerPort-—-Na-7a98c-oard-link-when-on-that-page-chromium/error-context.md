...
Locator: locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Dashboard' }).locator('..')
...
Call log:
  ...
  - waiting for locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Dashboard' }).locator('..')
