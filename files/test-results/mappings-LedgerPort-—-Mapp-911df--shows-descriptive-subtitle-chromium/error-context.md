...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Products tab shows descriptive subtitle
- Location: tests/mappings.spec.ts:52:7
...
Locator: getByText(/Unmapped products use the default fallback/i)
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText(/Unmapped products use the default fallback/i)
