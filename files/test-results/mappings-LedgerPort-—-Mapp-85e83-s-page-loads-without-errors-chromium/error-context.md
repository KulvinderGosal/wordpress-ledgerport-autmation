...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Mappings page loads without errors
- Location: tests/mappings.spec.ts:12:7
...
Expected pattern: not /Fatal error|Warning:|not allowed/i
Received string: "
...
Call log:
  ...
  - waiting for locator('body')
    63 × locator resolved to <body id="error-page">…</body>
       - unexpected value "
	Sorry, you are not allowed to access this page.
