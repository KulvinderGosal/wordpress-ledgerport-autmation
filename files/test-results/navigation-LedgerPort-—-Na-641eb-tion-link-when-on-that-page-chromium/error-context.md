...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> sidebar highlights "Connection" link when on that page
...
Locator: locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Connection' }).locator('..')
...
Call log:
  ...
  - waiting for locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Connection' }).locator('..')
