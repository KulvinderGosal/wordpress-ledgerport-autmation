...
- Name: debug-logs.spec.ts >> LedgerPort — Debug Logs >> empty state message is shown when no log files exist
- Location: tests/debug-logs.spec.ts:52:7

# Error details

```
Error: page.goto: net::ERR_NETWORK_CHANGED at https://qastaging.pushengage.com/wp-admin/
Call log:
