...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> direct URL loads Connection
- Location: tests/navigation.spec.ts:26:9
...
Expected pattern: not /not allowed|Fatal error/i
Received string: "
