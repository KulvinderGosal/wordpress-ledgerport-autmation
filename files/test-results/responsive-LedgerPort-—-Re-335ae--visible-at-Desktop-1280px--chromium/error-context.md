...
- Name: responsive.spec.ts >> LedgerPort — Responsive & UI >> heading visible at Desktop (1280px)
- Location: tests/responsive.spec.ts:27:9
...
Locator: getByRole('heading', { name: /Overview/i }).first()
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Overview/i }).first()
