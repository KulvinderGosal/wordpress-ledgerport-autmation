...
- Name: manual-sync.spec.ts >> LedgerPort — Manual Sync (Send to QuickBooks) >> footer note about background sync is visible
- Location: tests/manual-sync.spec.ts:112:7
