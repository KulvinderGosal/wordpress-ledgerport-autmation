...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> "View error log" on dashboard routes to Audit Logs
- Location: tests/navigation.spec.ts:92:7
...
Call log:
  - waiting for getByRole('button', { name: /View error log/i })
