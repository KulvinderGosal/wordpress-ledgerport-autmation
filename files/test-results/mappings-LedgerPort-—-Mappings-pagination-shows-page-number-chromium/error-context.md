...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> pagination shows page number
- Location: tests/mappings.spec.ts:105:7
...
Locator: locator('text=/Page \\d+ of \\d+/i').first()
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('text=/Page \\d+ of \\d+/i').first()
