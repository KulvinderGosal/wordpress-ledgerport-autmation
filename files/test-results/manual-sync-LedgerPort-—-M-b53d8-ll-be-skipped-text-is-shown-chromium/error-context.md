...
- Name: manual-sync.spec.ts >> LedgerPort — Manual Sync (Send to QuickBooks) >> "Products already synced will be skipped" text is shown
- Location: tests/manual-sync.spec.ts:76:7
