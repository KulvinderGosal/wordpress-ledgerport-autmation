...
- Name: manual-sync.spec.ts >> LedgerPort — Manual Sync (Send to QuickBooks) >> "Push Products to QuickBooks" section heading is visible
- Location: tests/manual-sync.spec.ts:68:7
