...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Automap Products button is visible
- Location: tests/mappings.spec.ts:97:7
...
Locator: getByRole('button', { name: /Automap Products/i }).or(getByText(/Automap Products/i))
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Automap Products/i }).or(getByText(/Automap Products/i))
