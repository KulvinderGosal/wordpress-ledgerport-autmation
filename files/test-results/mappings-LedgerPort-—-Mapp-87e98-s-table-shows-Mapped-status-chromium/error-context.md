...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Products table shows Mapped status
- Location: tests/mappings.spec.ts:85:7
...
Locator: getByText(/Mapped/i).first()
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText(/Mapped/i).first()
