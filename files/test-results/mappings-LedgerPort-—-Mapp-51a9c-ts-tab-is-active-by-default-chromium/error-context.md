...
- Name: mappings.spec.ts >> LedgerPort — Mappings >> Products tab is active by default
- Location: tests/mappings.spec.ts:42:7
...
Locator: getByText(/Map WooCommerce Products to QuickBooks/i)
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText(/Map WooCommerce Products to QuickBooks/i)
