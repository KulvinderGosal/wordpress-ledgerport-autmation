...
- Name: manual-sync.spec.ts >> LedgerPort — Manual Sync (Send to QuickBooks) >> page subtitle describes background processing
- Location: tests/manual-sync.spec.ts:30:7
