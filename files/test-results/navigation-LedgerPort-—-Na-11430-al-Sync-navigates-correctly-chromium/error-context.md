...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> sidebar link "Manual Sync" navigates correctly
...
Call log:
  - waiting for locator('#toplevel_page_ledgerport').getByRole('link', { name: 'Manual Sync' })
