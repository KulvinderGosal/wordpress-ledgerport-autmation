...
- Name: navigation.spec.ts >> LedgerPort — Navigation >> "View report" on dashboard routes to a plugin page
- Location: tests/navigation.spec.ts:108:7
...
Call log:
  - waiting for getByRole('button', { name: /View report/i })
