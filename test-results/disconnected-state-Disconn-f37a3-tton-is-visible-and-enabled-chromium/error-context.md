...
- Name: disconnected-state.spec.ts >> Disconnected State — Dashboard >> LP-DIS-006 | Banner "Connect your store" CTA button is visible and enabled
- Location: tests/disconnected-state.spec.ts:89:7
