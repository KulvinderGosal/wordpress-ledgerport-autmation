...
- Name: disconnected-state.spec.ts >> Disconnected State — Debug Logs Page >> LP-DIS-083 | Debug Logs "Connect your store" CTA button is visible and enabled
- Location: tests/disconnected-state.spec.ts:515:7
