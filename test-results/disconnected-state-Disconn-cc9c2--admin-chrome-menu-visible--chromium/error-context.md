...
- Name: disconnected-state.spec.ts >> Disconnected State — Manual Sync Page (Access Restricted) >> LP-DIS-072 | Manual Sync restricted page still shows WordPress admin chrome (menu visible)
- Location: tests/disconnected-state.spec.ts:441:7
