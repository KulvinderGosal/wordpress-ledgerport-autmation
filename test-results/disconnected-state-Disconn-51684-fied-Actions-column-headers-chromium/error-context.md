...
- Name: disconnected-state.spec.ts >> Disconnected State — Debug Logs Page >> LP-DIS-088 | Log files table shows "File", "Size", "Last Modified", "Actions" column headers
- Location: tests/disconnected-state.spec.ts:541:7
...
Expected: visible
Error: strict mode violation: getByText('File') resolved to 9 elements:
    1) <a href="media-new.php">Add Media File</a> aka getByRole('link', { name: 'Add Media File' })
    2) <a href="theme-editor.php">Theme File Editor</a> aka getByRole('link', { name: 'Theme File Editor' })
    3) <a href="plugin-editor.php">Plugin File Editor</a> aka getByRole('link', { name: 'Plugin File Editor' })
    4) <a href="profile.php">Profile</a> aka getByRole('link', { name: 'Profile' })
    5) <a href="admin.php?page=wpcode-file-editor">File Editor</a> aka getByRole('link', { name: 'File Editor', exact: true })
    6) <span class="display-name edit-profile">Edit Profile</span> aka getByText('Edit Profile')
    7) <p class="mt-1 text-sm text-muted-foreground">View, download, and manage plugin debug log files.</p> aka getByText('View, download, and manage')
    8) <h3 class="font-bold tracking-tight text-foreground text-xl">Log Files</h3> aka getByRole('heading', { name: 'Log Files' })
    9) <th class="text-left px-4 py-2 font-medium">File</th> aka getByRole('columnheader', { name: 'File' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('File')
    ...
    - main [ref=e317]:
      - generic [ref=e320]:
        - generic [ref=e321]:
          ...
          - generic [ref=e335]:
            - generic [ref=e337]:
              - heading "Debug Logs" [level=1] [ref=e338]
              - paragraph [ref=e339]: View, download, and manage plugin debug log files.
            - generic [ref=e343]:
              - generic [ref=e344]:
          ...
          - generic [ref=e370]:
            - generic [ref=e371]:
              - generic [ref=e372]:
                - heading "Log Files" [level=3] [ref=e373]
                - paragraph [ref=e374]:
                  - text: Logs are stored in
                  - code [ref=e375]: wp-content/uploads/ledgerport/logs/
              - generic [ref=e376]:
                - button "Refresh" [ref=e377] [cursor=pointer]
                - button "Clear All Logs" [ref=e378] [cursor=pointer]
            - table [ref=e381]:
              - rowgroup [ref=e382]:
                - row "File Size Last Modified Actions" [ref=e383]:
                  - columnheader "File" [ref=e384]
                  - columnheader "Size" [ref=e385]
                  - columnheader "Last Modified" [ref=e386]
                  - columnheader "Actions" [ref=e387]
              - rowgroup [ref=e388]:
                - row "debug-7d4e0b4e.log 1000 B 5/18/2026, 2:56:16 PM" [ref=e389]:
                  - cell "debug-7d4e0b4e.log" [ref=e390]
                  - cell "1000 B" [ref=e391]
                  - cell "5/18/2026, 2:56:16 PM" [ref=e392]
                  - cell [ref=e393]:
                    - generic [ref=e394]:
  ...
  - contentinfo [ref=e403]:
    - paragraph [ref=e404]:
      - generic [ref=e406]:
        ...
        - link "WordPress" [ref=e407] [cursor=pointer]:
          - /url: https://wordpress.org/
        - text: .
    - paragraph [ref=e408]: Version 6.9.4
```
