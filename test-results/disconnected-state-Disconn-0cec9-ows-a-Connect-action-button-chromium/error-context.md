...
- Name: disconnected-state.spec.ts >> Disconnected State — Dashboard >> LP-DIS-033 | "Connect WooCommerce" item shows a "Connect" action button
- Location: tests/disconnected-state.spec.ts:217:7
...
Locator: getByText('Connect WooCommerce').locator('..').locator('..').getByRole('button', { name: /connect/i }).or(getByText('Connect WooCommerce').locator('..').locator('..').getByText('Connect'))
Expected: visible
Error: strict mode violation: getByText('Connect WooCommerce').locator('..').locator('..').getByRole('button', { name: /connect/i }).or(getByText('Connect WooCommerce').locator('..').locator('..').getByText('Connect')) resolved to 2 elements:
    1) <span class="text-sm text-foreground">Connect WooCommerce</span> aka getByText('Connect WooCommerce')
    2) <button class="appearance-none inline-flex !cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-semibold !no-underline transition-colors !outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 [&_a]:!no-underline !border !border-border/80 bg-card text-foreground !shadow-none hover:…>Connect</button> aka getByRole('button', { name: 'Connect' }).first()

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Connect WooCommerce').locator('..').locator('..').getByRole('button', { name: /connect/i }).or(getByText('Connect WooCommerce').locator('..').locator('..').getByText('Connect'))
