...
- Name: disconnected-state.spec.ts >> Disconnected State — Dashboard >> LP-DIS-015 | "View report →" link is still visible in disconnected state
- Location: tests/disconnected-state.spec.ts:133:7
...
Locator: getByRole('link', { name: /view report/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /view report/i })
