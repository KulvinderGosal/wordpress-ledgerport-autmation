...
- Name: disconnected-state.spec.ts >> Disconnected State — Connect CTA Navigation >> LP-DIS-096 | Mappings gated area "Connect your store" CTA is clickable and navigates
- Location: tests/disconnected-state.spec.ts:599:7
...
Call log:
  - waiting for getByRole('button', { name: /connect your store/i }).last()
