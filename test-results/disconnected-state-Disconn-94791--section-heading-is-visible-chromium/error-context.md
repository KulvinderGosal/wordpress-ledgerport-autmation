...
- Name: disconnected-state.spec.ts >> Disconnected State — Debug Logs Page >> LP-DIS-084 | "Log Files" section heading is visible
- Location: tests/disconnected-state.spec.ts:521:7
...
Locator: getByText('Log Files')
Expected: visible
Error: strict mode violation: getByText('Log Files') resolved to 2 elements:
...
Call log:
  ...
  - waiting for getByText('Log Files')
