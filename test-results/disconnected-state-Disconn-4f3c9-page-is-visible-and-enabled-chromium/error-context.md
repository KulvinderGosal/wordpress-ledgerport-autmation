...
- Name: disconnected-state.spec.ts >> Disconnected State — Connection Page >> LP-DIS-053 | "Connect your store" CTA button on Connection page is visible and enabled
- Location: tests/disconnected-state.spec.ts:323:7
...
Locator: getByRole('button', { name: /connect your store/i })
Expected: visible
Timeout: 5000ms
...
- main:
  ...
  - paragraph: Manage how LedgerPort connects to your store and accounting platform.
